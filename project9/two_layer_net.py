...
# 
# $\color{blue}{\textit Your Answer:}$ set hidden sizes 1024, learning rates 0.001, and regularization strengths 0.75 and 0.8.
# compute the train accuracy and validation accuracy for each value.
# find the best model which has the best validation accuracy when regularization strength is 0.75 or 0.8.
...
hidden_sizes = [1024]
learning_rates = [1e-3]
regularization_strengths = [0.75, 0.8]
best_stats = None
...
# 
# $\color{blue}{\textit Your Explanation:}$ Larger dataset and increasing the regularization strength can decrease the gap between testing accuracy and the training accuracy, but adding more hidden nodes cause over-fitting.
# 
# 
