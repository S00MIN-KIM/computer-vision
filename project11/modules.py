            ...
            for i in range(preds.shape[0]):
                ...
                for j in range(temp.shape[0]):
                    for k in range(temp.shape[1]):
                        ...
                        temp_rgb[j][k][0] = cls_invert[temp[j][k]][0]
                        temp_rgb[j][k][1] = cls_invert[temp[j][k]][1]
                        temp_rgb[j][k][2] = cls_invert[temp[j][k]][2]

                        temp_label[j][k][0] = cls_invert[temp_l[j][k]][0]
                        temp_label[j][k][1] = cls_invert[temp_l[j][k]][1]
                        temp_label[j][k][2] = cls_invert[temp_l[j][k]][2]
