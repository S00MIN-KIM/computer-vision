...
class ResNet50_layer4(nn.Module):
    def __init__(self, num_class=10 ): # Hint : How many classes in Cifar-10 dataset?
        ...
        self.fc = nn.Linear(1024, num_class) # Hint : Think about the reason why fc layer is needed
